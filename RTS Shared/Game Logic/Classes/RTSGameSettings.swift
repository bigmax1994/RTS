...
extension RTSGame {
    ...
    //heightmap params
    static let heightLevels:[(height:Float, beginsAt:Float, sharpness:Float)] = [(0.25, -0.4, 15),(0.31, 0.1, 2), (0.71, 0.55, 3), (1.0, 1.10, 13)] //Heightlevels, which will be more present in the Heightmap (each gets a sigmoid)
    static let amplitudes:[Float]=[1.9, 1.3, 0.7, 0.05] //amplitudes of perlin layers
