...
extension RTSGame {
    ...
    //heightmap params
    static let heightLevels:[(height:Float, beginsAt:Float, sharpness:Float)] = [(0.35, -0.4, 26),(0.41, 0.1, 22), (0.51, 0.65, 12), (1.0, 0.95, 13)] //Heightlevels, which will be more present in the Heightmap (each gets a sigmoid)
